  ...
  <view class="navbar-fixed">
    ...
    <view class="navbar" :style="{paddingTop: safeAreaInsets?.top + 'px'}">
      ...
      <view class="logo">
        ...
        <text class="logo-text" style="font-size: 32rpx; font-weight: bold; border-left: none; padding-left: 0; margin-left: 10rpx;">
          简单外卖 · 客户端
        </text>
      </view>
      <view class="logo">
    ...
    <view class="info">
      ...
      <view class="info2">
        <text class="address">餐厅地址：南京市江宁区东南大学九龙湖校区</text>
